...
function parseCsvText(text: string): TaskImportForm['file'] {
  ...
  const priorityIdx = headerLine.findIndex((h) => h.toLowerCase().includes('priority'))

  const results: { id: string; title: string; status: string; label: string; priority: string }[] = []
